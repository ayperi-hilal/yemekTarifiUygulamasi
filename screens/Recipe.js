...
import {View,Text,Image,TouchableOpacity,Animated,Platform, Touchable} from 'react-native';
...
const RecipeCreatorCardDetail=({selectedRecipe})=>{
    return(
        ...
        >
            ...
            >
                <Text style={{color:COLORS.lightGray2,...FONTS.body4}}>Tarifi : </Text>
            ...
            <TouchableOpacity
                ...
                onPress={()=>console.log("profili göster")}
            >
                <Image
...
const Recipe=({navigation,route})=>{
    ...
    function renderHeaderBar(){
        return(
            ...
            >
                {/*yukarı kaydığında arka plamnı siyah yapma */}
                <Animated.View
                    style={{
                        position:'absolute',
                        top:0,
            ...
            <Animated.Image
                ...
                style={{
                    ...
                    transform:[
                        {
                            translateY:scrollY.interpolate({
                                inputRamge:[-HEADER_HEIGHT,0,HEADER_HEIGHT],
                                outputRange:[-HEADER_HEIGHT/2,0,HEADER_HEIGHT*0,75]
                            })
                        },
                        {
                            scale:scrollY.interpolate({
                                importRange:[-HEADER_HEIGHT,0,HEADER_HEIGHT],
...
function renderIngredientHeader(){ 
    ...
    return(
        ...
        >
            ...
            >
                {selectedRecipe?.ingredients.length} ögeler
    ...
    return(
        ...
        >
            ...
            onScroll={Animated.event([
                {naviteEvent:{contentOffSet:{y:scroll}}}
            ...
            renderItem={({item})=>(
                ...
                >{/*icon */}
                   <View
                    ...
                    >
                        <Image
                                source={{item,icon}}/*nokta olunca hata verdi kod */
                                style={{
                                    height:40,
                                    width:40
                                }}
